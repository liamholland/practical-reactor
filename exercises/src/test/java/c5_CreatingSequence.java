...
public class c5_CreatingSequence {
     ...
     *
     * Answer:
     * - What is difference between `generate` and `create`?    sync vs. async
     * - What is difference between `create` and `push`?        multi-threaded vs. single threaded
     */
    @Test
    ...
    public void multi_threaded_producer() {
        //originally got lucky with a change and the test passed, this is the correct solution
