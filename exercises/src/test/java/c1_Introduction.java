...
public class c1_Introduction extends IntroductionBase {
    ...
    public void empty_service() {
        ...
        Optional<String> optionalServiceResult = serviceResult.blockOptional(Duration.of(1, ChronoUnit.SECONDS)); //todo: change this line only
    ...
    public void multi_result_service() {
        ...
        String result = serviceResult.blockFirst().toString(); //todo: change this line only
    ...
    public void nothing_happens_until_you_() throws InterruptedException {
        ...
        Thread.sleep(1000); //bonus: can you explain why this line is needed?
                                   //answer: to allow for the async part to happen
